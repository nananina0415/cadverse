...
# CADverse 개발 환경 셋업 스크립트
# PyChrono 공식 가이드 기반: https://api.projectchrono.org/pychrono_installation.html

set -e  # 에러 발생 시 중단

echo "=================================================="
echo "CADverse 개발 환경 셋업"
echo "=================================================="
echo ""
...
# 3. 기존 환경 확인
if conda env list | grep -q "^cadverse "; then
